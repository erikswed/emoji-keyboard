...
import com.gotcreations.emojikeyboard.controller.ActivityWhatsAppForFragment;
...
public class TelegramFragment extends EmojiCompatFragment implements AppPanelEventListener {

    public static final String TAG = "TelegramFragment";

    private TelegramPanelForFragment mBottomPanel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_telegram, parent, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.mBottomPanel = new TelegramPanelForFragment(this, this);
    }
    ...
    private void initMessageList() {
        this.mMessages = (RecyclerView) getView().findViewById(R.id.messages);
